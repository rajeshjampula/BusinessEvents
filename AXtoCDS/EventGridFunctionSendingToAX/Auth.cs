...
namespace EventGridFunctionSendingToAX
{
    class Auth
    {
        ...
        public static async Task<string> GetAuthenticationHeader(bool useWebAppAuthentication = false)
        {
            string aadTenant = Config.Default.ActiveDirectoryTenant;
            string aadClientAppId = Config.Default.ActiveDirectoryClientAppId;
            string aadClientAppSecret = Config.Default.ActiveDirectoryClientAppSecret;
            string aadResource = Config.Default.ActiveDirectoryResource;
            ...
            else
            {
                ...
                string password = Config.Default.Password;
